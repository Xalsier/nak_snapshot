...
映=e=>{(面||((面=書[元]("div"))[名]="eic",書.body.appendChild(面)),e).some(e=>載(e.src))},
造=(e,n,a,s)=>(d=書[元]("div"),
    i=日(a,s),
    d[名]="cc",
    Array.from({length:i}).forEach(()=>d.appendChild(Object.assign(書[元]("div"),{[名]:"cd empty"}))),
    Array.from({length:n},(_,n)=>n+1).forEach(n=>{let o=書[元]("div"),
    c=e[`${a}-${(s+1+"").padStart(2,"0")}-${(n+"").padStart(2,"0")}`];
    o[名]="cd",o.setAttribute("data-day",n),o.innerHTML=n,
    今(a,s,n)&&o.classList.add("today"),
    古(a,s,n)?o.classList.add("past",`past-event-${c?.type}`):o.classList.add(`event-${c?.type}`),
...
旧=(書=document)[找]("pm"),
新=書[找]("nm"),
    (更=e=>{初.setMonth(初.getMonth()+e),
        年=初.getFullYear(),
        月=初.getMonth(),
        数=new Date(年,月+1,0).getDate(),
        設(年,月),獲().then(e=>{(根=書[找]("ca")).innerHTML="",
